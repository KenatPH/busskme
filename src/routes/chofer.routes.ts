...
import { create, update, register, deleteChofer, getDataChoferes, getChofer, getChoferByUserId, testmailChofer } from "../controllers/chofer.controller";
...
router.get('/correo', testmailChofer)
