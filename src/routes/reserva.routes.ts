...
import { activarReserva, create, deleteReserva, getReserva, getDataReservas, getDataReservasByOperador, getDataReservasBycliente, consolidarReserva } from "../controllers/reserva.controller";
...
router.post('/consolidar', checkAuth, consolidarReserva);
